...
⭐Arxiv论文精细翻译 (**需要**[安装texLive](https://github.com/HSqure/gpt_academic/blob/master/docs/latex_install_ubuntu20.md)) | [函数插件] 一键[以超高质量翻译arxiv论文](https://www.bilibili.com/video/BV1dz4y1v77A/)，目前最好的论文翻译工具
